...
import bgu.spl.mics.application.passiveObjects.InitializeManager;
...
public abstract class MicroService implements Runnable {
     ...
     * registers the microservice to the bus
     * initializes the mocroservice
     * while it does not terminate: wait for a message, if you get one- take care of it (call)
     * unregisters from message bus
     */
    @Override
    public final void run() {
        MessageBusImpl.getInstance().register(this);
        initialize();
        InitializeManager.getInstance().increase();
        while (!terminated) {
